...
cargo install --force subkey --git https://https://github.com/AXIA-DEV/axlib --version <SET VERSION> --locked
```
...
You can read more about the SS58 format in the [axlib wiki](https://https://github.com/AXIA-DEV/axlib/wiki/External-Address-Format-(SS58)) and see the list of reserved prefixes in the [Axia wiki](https://wiki.axia.network/docs/build-ss58-registry).
